...
public class AddPointActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        exChangeCurrent = preferencesManager.getStringValue(Constant.CURRENCY);
        if (exChangeCurrent.equals(Constant.LKR)) {
    ...
    public void payment() {
        if (txtPoint.getText().toString().trim().length() != 0) {
            //Double moneyInt = Double.parseDouble(txtPoint.getText().toString().trim());
